...
public class ParserTests
{
    ...
    [
        ...
        [ "\"hello this is a string\"", new [] { Token.StringLiteral("hello this is a string", new SourceSpan(new SourcePosition(0, 0, 0), 24)) } ],
        ...
        ["pub fn", new [] { Token.Pub(new SourceSpan(new SourcePosition(0, 0, 0), 3)), Token.Fn(new SourceSpan(new SourcePosition(4, 0, 4), 2)) }],
        ["pub 5", new [] { Token.Pub(new SourceSpan(new SourcePosition(0, 0, 0), 3)), Token.IntLiteral(5, new SourceSpan(new SourcePosition(4, 0, 4), 1)) }],
        ["5 pub", new [] { Token.IntLiteral(5, new SourceSpan(new SourcePosition(0, 0, 0), 1)), Token.Pub(new SourceSpan(new SourcePosition(2, 0, 2), 3)) }],
        ["\"string\" pub", new [] { Token.StringLiteral("string", new SourceSpan(new SourcePosition(0, 0, 0), 8)), Token.Pub(new SourceSpan(new SourcePosition(9, 0, 9), 3)) }],
        
        // multiple tokens without separation
        ["int)", new[] { Token.IntKeyword(new SourceSpan(new SourcePosition(0, 0, 0), 3)), Token.RightParenthesis(new SourceSpan(new SourcePosition(3, 0, 3), 1))}],
        ["a)", new[] { Token.Identifier("a", new SourceSpan(new SourcePosition(0, 0, 0), 1)), Token.RightParenthesis(new SourceSpan(new SourcePosition(1, 0, 1), 1))}],
        ["i)", new[] { Token.Identifier("i", new SourceSpan(new SourcePosition(0, 0, 0), 1)), Token.RightParenthesis(new SourceSpan(new SourcePosition(1, 0, 1), 1))}],
        [
            "a)?;", new[]
            {
        ...
        [" pub fn ", new [] { Token.Pub(new SourceSpan(new SourcePosition(1, 0, 1), 3)), Token.Fn(new SourceSpan(new SourcePosition(5, 0, 5), 2)) }],
        ["pub fn ", new [] { Token.Pub(new SourceSpan(new SourcePosition(0, 0, 0), 3)), Token.Fn(new SourceSpan(new SourcePosition(4, 0, 4), 2)) }],
        [" pub fn", new [] { Token.Pub(new SourceSpan(new SourcePosition(1, 0, 1), 3)), Token.Fn(new SourceSpan(new SourcePosition(5, 0, 5), 2)) }],
        [" pub  fn", new [] { Token.Pub(new SourceSpan(new SourcePosition(1, 0, 1), 3)), Token.Fn(new SourceSpan(new SourcePosition(6, 0, 6), 2)) }],
        ["\tpub\tfn\t", new [] { Token.Pub(new SourceSpan(new SourcePosition(1, 0, 1), 3)), Token.Fn(new SourceSpan(new SourcePosition(5, 0, 5), 2)) }],
