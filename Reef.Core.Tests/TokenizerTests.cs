...
public class TokenizerTests
{
    ...
    public static IEnumerable<object[]> TestCases()
    {
        ...
        [
            ...
            ["#", new[] { Token.Hash(new SourceSpan(new SourcePosition(0, 0, 0), 1)) }],
            ...
            ["variantOf", new[] { Token.VariantOf(new SourceSpan(new SourcePosition(0, 0, 0), 9)) }],
            ...
            ["for", new[] { Token.For(new SourceSpan(new SourcePosition(0, 0, 0), 3)) }],
            ...
            ["int", new[] { Token.Identifier("int", new SourceSpan(new SourcePosition(0, 0, 0), 3)) }],
            ...
            ["--", new[] { Token.DoubleDash(new SourceSpan(new SourcePosition(0, 0, 0), 2)) }],
            ...
            ["result", new[] { Token.Identifier("result", new SourceSpan(new SourcePosition(0, 0, 0), 6)) }],
            ["u8", new[] { Token.Identifier("u8", new SourceSpan(new SourcePosition(0, 0, 0), 2)) }],
            ...
            ["3", new[] { Token.IntLiteral(3, new SourceSpan(new SourcePosition(0, 0, 0), 1)) }],
            ["4", new[] { Token.IntLiteral(4, new SourceSpan(new SourcePosition(0, 0, 0), 1)) }],
            ["5", new[] { Token.IntLiteral(5, new SourceSpan(new SourcePosition(0, 0, 0), 1)) }],
            ["6", new[] { Token.IntLiteral(6, new SourceSpan(new SourcePosition(0, 0, 0), 1)) }],
            ["7", new[] { Token.IntLiteral(7, new SourceSpan(new SourcePosition(0, 0, 0), 1)) }],
            ...
            // new line
            ["\r\nbool", new[] { Token.Identifier("bool", new SourceSpan(new SourcePosition(2, 1, 0), 4)) }],
            ["\r\n\r\nbool", new[] { Token.Identifier("bool", new SourceSpan(new SourcePosition(4, 2, 0), 4)) }],
            ["\r\n\r\n  bool", new[] { Token.Identifier("bool", new SourceSpan(new SourcePosition(6, 2, 2), 4)) }],
            ["\r\n  \r\n  bool", new[] { Token.Identifier("bool", new SourceSpan(new SourcePosition(8, 2, 2), 4)) }],
            ...
            [
                ...
                new[]
                {
                    Token.Identifier("int", new SourceSpan(new SourcePosition(0, 0, 0), 3)),
            ...
            [
                ...
                new[]
                {
                    ...
                    Token.Identifier("int", new SourceSpan(new SourcePosition(22, 0, 22), 3)),
                    ...
                    Token.Identifier("result", new SourceSpan(new SourcePosition(28, 0, 28), 6)),
                    Token.LeftAngleBracket(new SourceSpan(new SourcePosition(34, 0, 34), 1)),
                    Token.Identifier("int", new SourceSpan(new SourcePosition(35, 0, 35), 3)),
                    Token.Comma(new SourceSpan(new SourcePosition(38, 0, 38), 1)),
                    Token.Identifier("string", new SourceSpan(new SourcePosition(40, 0, 40), 6)),
                    ...
                    Token.Identifier("ok", new SourceSpan(new SourcePosition(103, 4, 15), 2)),
