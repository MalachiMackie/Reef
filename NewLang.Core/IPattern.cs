...
public record UnionVariantPattern(TypeIdentifier Type, StringToken VariantName, StringToken? VariableName, SourceRange SourceRange) : IPattern;

public record UnionTupleVariantPattern(
    TypeIdentifier Type,
    StringToken VariantName,
    IReadOnlyList<IPattern> TupleParamPatterns,
    StringToken? VariableName, SourceRange SourceRange) : IPattern;
